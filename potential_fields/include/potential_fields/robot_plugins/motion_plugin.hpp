...
public:
  ...
  virtual void assignIKSolver(std::shared_ptr<pfield::IKSolver> ikSolver) { this->ikSolver = ikSolver; }
  virtual std::shared_ptr<pfield::IKSolver> getIKSolver() const { return ikSolver; }
