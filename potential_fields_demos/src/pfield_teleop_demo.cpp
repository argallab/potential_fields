...
void PFTeleopDemo::createAndPublishObstacles() {
  ...
  cage.type = "Mesh";
  cage.group = "Static";
  // std::string share_directory = ament_index_cpp::get_package_share_directory("potential_fields_demos");
  cage.mesh_resource = "package://potential_fields_demos/meshes/r01_scene/icos_mesh.obj";
